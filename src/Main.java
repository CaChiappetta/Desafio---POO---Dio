...
public class Main {
 ...
 curso1.setCargaHoraria(8);
        ...
        System.out.println("Conteúdos Inscritos Sandro:" + devSandro.getConteudosInscritos());
        devSandro.progredir();
        devSandro.progredir();
        devSandro.progredir();
        System.out.println("Conteúdos Inscritos Sandro:" + devSandro.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Sandro" + devSandro.getConteudosConcluidos());
